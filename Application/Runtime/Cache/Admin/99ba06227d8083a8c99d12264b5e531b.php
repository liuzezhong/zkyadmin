                        ...
                        <div class="box-body">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">赛事类型</th>
                                    <th class="text-center">总人数</th>
                                    <th class="text-center">主办方</th>
                                    <th class="text-center">承办方</th>
                                    ...
                                    <th class="text-center">赛事状态</th>
                                    <th class="text-center">操作</th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php if(is_array($matchs)): $i = 0; $__LIST__ = $matchs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$match): $mod = ($i % 2 );++$i;?><tr>
                                        <td class="text-center"><?php echo ($match["match_title"]); ?></td>
                                        <td class="text-center"><?php echo ($match["event_name"]); ?></td>
                                        <td class="text-center"><?php echo ($match["headcount"]); ?></td>
                                        <td class="text-center"><?php echo ($match["sponsor"]); ?></td>
                                        <td class="text-center"><?php echo ($match["undertake"]); ?></td>
                                        <td class="text-center"><?php echo ($match["leader"]); ?></td>
                                        <td class="text-center"><?php echo ($match["leader_tel"]); ?></td>
                                        <td class="text-center"><?php echo ($match["match_stime"]); ?></td>
                                        <td class="text-center"><?php echo ($match["enrol_etime"]); ?></td>
                                        <td class="text-center"><?php echo ($match["user_name"]); ?></td>
                                        <td class="text-center"><?php echo ($match["gmt_create"]); ?></td>
                                        <td class="text-center">
                                            <?php if($match["is_finish"] == 0): ?><span class="label label-warning" id="change-status" attr-id="<?php echo ($match["match_id"]); ?>" attr-status="<?php echo ($match["is_finish"]); ?>" attr-m="admin" attr-c="match" attr-a="changeStatus">进行中</span>
                                                ...
                                                <span class="label label-danger">冻结中</span><?php endif; ?>
                                        </td>
                                        <td class="text-center">
                                            <span id="edit-info" attr-id="<?php echo ($match["match_id"]); ?>" attr-m="admin" attr-c="match" attr-a="edit" attr-name="match_id">
                                                <i class="fa fa-edit fa-fw"></i>
                                            </span>
                                            <span id="delete-info" attr-id="<?php echo ($match["match_id"]); ?>" attr-name="<?php echo ($match["match_title"]); ?>" attr-m="admin" attr-c="match" attr-a="deleteMatch">
