        ...
        <section class="content">
            ...
            <div class="box box-default">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>赛事名称</label>
                                <input type="text" class="form-control" name="match_title" placeholder="请输入赛事名称">
                            </div>
                            <div class="form-group">
                                <label>赛事主办方</label>
                                <input type="text" class="form-control" name="sponsor" placeholder="请输入主办方名">
                            </div>
                            <div class="form-group">
                                <label>赛事负责人</label>
                            ...
                            <div class="form-group">
                                <label>最大参赛人数</label>
                                <input type="text" class="form-control" name="headcount" placeholder="请输入最多参赛人数">
                            </div>
                            <div class="form-group">
                                <label>比赛开始截止时间</label>
                                <!--<input type="text" class="form-control pull-right" id="reservationtime">-->
                                <input type="text" class="form-control" name="match_time" id="reservationtime">
                            </div>
                            <!-- /.form-group -->
                            <div class="form-group">
                                <label>赛事规程</label>
                                <textarea class="form-control" rows="3" placeholder="请输入详细的赛事规程" name="match_detail"></textarea>
                            </div>
                            <div class="form-group">
                                <label>比赛项目-报名费用-报名方式（格式如：男女混双-10-0,输入完回车,报名方式0为个人，1为团队）</label>
                                <input type="text" class="form-control" value="" data-role="tagsinput" name="category"/>
                            </div>
                            <!-- /.form-group -->
                        </div>
                        <!-- /.col -->
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" style="width: 100%;" id="event_id">
                                    ...
                                    <?php if(is_array($events)): $i = 0; $__LIST__ = $events;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$event): $mod = ($i % 2 );++$i;?><option value="<?php echo ($event["event_id"]); ?>"><?php echo ($event["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                            <!-- /.form-group -->
                            <div class="form-group">
                                <label>赛事承办方</label>
                                <input type="text" class="form-control" name="undertake" placeholder="请输入承办名">
                            </div>
                            <!-- /.form-group -->
                            <div class="form-group">
                                <label>负责人手机</label>
                                <input type="text" class="form-control" name="leader_tel" placeholder="请输入负责人手机号码">
                            </div>
                            <div class="form-group">
                                <label>每人可报项数(0为无限制)</label>
                                <input type="text" class="form-control" name="register_max" placeholder="请输入每人可报名项目，0为无限制">
                            </div>
                            <div class="form-group">
                                <label>报名开始截止时间</label>
                                <input type="text" class="form-control" name="enrol_time" id="reservationtime2">
                            </div>
                            <div class="form-group">
                                <label>比赛地址</label>
                                <textarea class="form-control" rows="3" placeholder="如：无锡市梁溪区运河西路222号" name="address"></textarea>
                            </div>
                            <div class="form-group">
                                <label>上传赛事封面图片（可多张）</label>
                ...
                <div class="box-footer">
                    <div class="col-md-12">
                        <div class="form-group">
                            <button type="button" class="form-control btn btn-primary" id="create-match">创建赛事信息</button>
                        </div>
                    </div>
                </div>
            </div>
